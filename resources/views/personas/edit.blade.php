            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" placeholder="Numero de documento" name="documento" value="{{ $persona->documento }}"/>
                        ...
                        <div class="col-3">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" placeholder="DV" name="digito_verificador" value="{{ $persona->digito_verificador }}"/>
                                <label>Nª DV</label>
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" name="cliente" {{ ($persona->cliente) ? 'checked' : '' }}>
                        <label class="form-check-label">Es Cliente?</label>
                    </div>

                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" name="proveedor" {{ ($persona->proveedor) ? 'checked' : '' }}>
