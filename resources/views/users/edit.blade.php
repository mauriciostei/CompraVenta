        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" placeholder="Correo" name="email"  value="{{ $user->email }}"/>
                        ...
                        @forelse($perfiles as $pe)
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" name="perfiles[]" value="{{$pe->id}}" {{ ($pe->activado) ? 'checked' : '' }} >
                                </div>
                            </li>
                        @empty
